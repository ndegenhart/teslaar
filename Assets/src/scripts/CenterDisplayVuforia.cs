...
/// </summary>
public class CenterDisplayVuforia : MonoBehaviour, ITrackableEventHandler
{
    ...
    protected virtual void OnTrackingFound()
    {
        if (mTrackableBehaviour)
        {
            ...
            if (Introduction_status.gameObject.activeSelf == false)
            {
    ...
    protected virtual void OnTrackingLost()
    {
        if (mTrackableBehaviour)
        {
            ...
            GameObject.Find("VideoPlayerCluster").GetComponent<UnityEngine.Video.VideoPlayer>().Pause();
